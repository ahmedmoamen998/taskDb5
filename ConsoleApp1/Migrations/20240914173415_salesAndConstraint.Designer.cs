...
namespace task5Db.Migrations
{
    ...
    [Migration("20240914173415_salesAndConstraint")]
    partial class salesAndConstraint
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("task5Db.Models.Sale", b =>
                {
                    b.HasOne("task5Db.Models.Customer", null)
                        .WithMany("salesCustomer")
                        .HasForeignKey("CustomerId");

                    b.HasOne("task5Db.Models.Product", null)
                        .WithMany("salesProduct")
                        .HasForeignKey("ProductId");

                    b.HasOne("task5Db.Models.Store", null)
                        .WithMany("salesStore")
